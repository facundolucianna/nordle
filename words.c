...
static const char *WORD_LIST[] = {
    ...
    "break", "breed", "brief", "bring", "broad", "brown", "buyer", "cable",
    "canal", "candy", "carry", "catch", "cause", "chain", "chair", "chart",
    ...
    "dance", "dated", "death", "decor", "delay", "depth", "doing", "doubt",
    "dozen", "draft", "drama", "drawn", "dream", "dress", "drive", "drove",
    ...
    "frank", "fraud", "fresh", "front", "fruit", "fully", "funny", "geese",
    ...
    "sight", "since", "sixty", "sized", "skill", "sleep", "slide", "small",
    ...
    "whole", "whose", "woman", "women", "world", "worry", "would", "write",
...
const char *get_random_word(void) {
  ...
  size_t total = sizeof(WORD_LIST) / sizeof(WORD_LIST[0]);
  size_t index = (size_t)rand() % total;
